...
#
# plaintxt = xor_decrypt( s, key )
# print( "plain_text:",plaintxt )
_KEY_LEN = 4
ori = base64.b64decode(s)
key = [1,1,1,1]
dec = np.zeros((64,64),dtype=int)
print(dec)
temp = []
for index ,byte in enumerate(ori):
    i = index % 64
    j = index // 64
    dec[j][i] = byte ^ key[index % _KEY_LEN ]
